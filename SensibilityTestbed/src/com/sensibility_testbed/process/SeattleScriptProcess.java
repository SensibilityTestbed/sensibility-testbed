...
/***
 *
 * Slightly modified version of the ScriptProcess from SL4A with the possibility
 * to launch scripts with command-line arguments and environmental variables,
 * and to specify the working directory of the script at launch time
 *
 */
