...
public class ScriptActivity extends Activity {
  ...
  private void killService() {
    final Intent intent = new Intent(getBaseContext(), ScriptService.class);
  ...
  private void showAdvancedInstallLayout() {
    ...
    button.setOnClickListener(new View.OnClickListener() {
      public void onClick(View v) {
        ...
        if (!allBox.isChecked()) {
          final String intlist = permittedInterfaces.getText().toString();
  ...
  private void showAboutLayout() {
    ...
    final TextView tw = (TextView) findViewById(R.id.aboutVersionView);
    try {
      // Get version name
      tw.setText("v"
  ...
  private void copyPythonToLocal() {
    ...
    InputStream content;
    final R.raw a = new R.raw();
    final java.lang.reflect.Field[] t = R.raw.class.getFields();
